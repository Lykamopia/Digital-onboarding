...
export enum SecurityEvent {
  ...
  // Phone-based Status Lookup
  PHONE_STATUS_LOOKUP_HIT  = 'PHONE_STATUS_LOOKUP_HIT',   // valid number, record found
  PHONE_STATUS_LOOKUP_MISS = 'PHONE_STATUS_LOOKUP_MISS',  // valid number, no record / invalid format
}
