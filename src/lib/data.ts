...
export const memos: MemoWithActivity[] = [
  {
    ...
    body: 'Please review the attached Q3 financial report and provide your feedback by EOD Friday. We need to finalize this for the board meeting next week.',
  ...
  },
  {
    ...
    body: 'Hi Ethan, please find the proposed IT maintenance schedule for November. Let me know if your team foresees any conflicts.',
    attachments: [],
  ...
  },
  {
    ...
    body: 'A reminder that our quarterly all-hands meeting is scheduled for this Thursday at 10:00 AM in the main auditorium. Please add it to your calendars. An agenda will be sent out shortly.',
    attachments: [],
